export default class GameView {
  ...
  draw() {
    ...
    let grd = ctx.createRadialGradient(centerX, centerY, centerY / 4, centerX, centerY, centerY * 4);
    grd.addColorStop(0, "black");
    grd.addColorStop(1, "grey");

    let grd2 = ctx.createRadialGradient(centerX, centerY, centerY / 20, centerX, centerY, centerY * 3);
    grd2.addColorStop(0, "#3d3d3d");
    grd2.addColorStop(0.5, "black");

    let grd3 = ctx.createRadialGradient(centerX, centerY, centerY / 20, centerX, centerY, centerY / 1.33);
